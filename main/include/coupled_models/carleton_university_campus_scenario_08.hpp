#ifndef CARLETON_UNIVERSITY_CAMPUS_SCENARIO_08_HPP
#define CARLETON_UNIVERSITY_CAMPUS_SCENARIO_08_HPP
...
// Scenario 08: Bronson & University Dr exit blocked (construction).
// Stadium Way → Bronson stays open (P5/P6/P7 NE egress). No Raven emergency link (r28).
// P1/P2 use Colonel By (DEVS south exit). Other lots use Stadium Way / Raven paths (OD).
struct CarletonUniversityCampusScenario08Coupled : public Coupled {

    CarletonUniversityCampusScenario08Coupled(const std::string& id, std::vector<ParkingLotSchedule> parkingLotSchedules,
...
#endif // CARLETON_UNIVERSITY_CAMPUS_SCENARIO_08_HPP
