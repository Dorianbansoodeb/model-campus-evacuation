#ifndef CARLETON_UNIVERSITY_CAMPUS_SCENARIO_07_HPP
#define CARLETON_UNIVERSITY_CAMPUS_SCENARIO_07_HPP
...
struct CarletonUniversityCampusScenario07Coupled : public Coupled {

    CarletonUniversityCampusScenario07Coupled(const std::string& id, std::vector<ParkingLotSchedule> parkingLotSchedules,
...
#endif // CARLETON_UNIVERSITY_CAMPUS_SCENARIO_07_HPP
